...
export default async function ProductsOfTheDay() {
  ...
  return (
    <section className="min-h-screen pt-16 justify-evenly gap-16 relative w-screen flex flex-col items-center">
      ...
      <div className="flex flex-row w-full justify-center gap-[5vw] px-[12vw]">
